export const genMockData = () => {
  ...
  for (let i = 0; i < 10; i++) {
    const competition: API.Competition = {
      ...
      intro: '这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍这是一段比赛文本介绍',
